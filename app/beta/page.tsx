...
export default function BetaPage() {
  return (
    <div className="pt-16">
      <section className="bg-gradient-to-br from-[#0F172A] via-[#111827] to-[#0F172A] py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <p className="mb-4 text-sm font-semibold uppercase tracking-[0.2em] text-[#06B6D4]">
                Join the beta
              </p>
            ...
            <div className="rounded-2xl border border-[#06B6D4]/20 bg-white/10 p-6 text-slate-100 shadow-xl backdrop-blur-sm">
              <h2 className="mb-3 text-xl font-semibold text-white">Why join?</h2>
      ...
      <section className="bg-slate-50 py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center">
            <h2 className="mb-3 text-3xl font-bold text-[#0F172A]">Beta waitlist signup</h2>
